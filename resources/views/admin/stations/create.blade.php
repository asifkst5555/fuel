...
@section('page_copy', 'Create a new Hathazari fuel station record and publish its current octane, petrol, and diesel availability.')
...
@section('content')
    <div class="form-card">
        <div class="mb-4">
            ...
            <p class="text-secondary mb-0">Add the station profile, dealer, location details, and initial fuel status.</p>
        </div>
